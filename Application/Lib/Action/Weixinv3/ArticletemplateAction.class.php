<?php
class ArticletemplateAction extends Weixinv3Action {
	...
	public function add() {
		...
		if($_POST) {
			//print_r($_POST);
			//echo "<br/><br/>";
			$_POST['desc'] = mb_substr(trimall(strip_tags($_POST["content"])), 0, 80);
			//exit;
		...
		$mubanid = intval(I("get.mubanid"));
		$catlist = $this->_cateModel->getCategoryList($wid, "article");

		$this->assign("catlist", $catlist);
		$this->display($this->Base_theme."/"."add".$mubanid);
	}
